...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIdNOToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Só é possível editar o seu usuário"))
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIdNOToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Só é possível deletar o seu usuário"))
		return
	}
